...
#SBATCH --mail-user=manlis@umd.edu
#SBATCH --mail-type=NONE
#SBATCH --exclude=cmlgrad05,cml15,cml11

source /cmlscratch/manlis/anaconda3/etc/profile.d/conda.sh 
source /nfshomes/manlis/.bashrc 
